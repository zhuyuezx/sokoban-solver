...
class FestivalSolver {
     ...
     * @returns {any}
     */
    solve(level, time_limit_ms) {
        const ptr0 = passStringToWasm0(level, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.festivalsolver_solve(this.__wbg_ptr, ptr0, len0, time_limit_ms);
        return ret;
    }
}
if (Symbol.dispose) FestivalSolver.prototype[Symbol.dispose] = FestivalSolver.prototype.free;

exports.FestivalSolver = FestivalSolver;
...
const wasmPath = `${__dirname}/festival_rust_bg.wasm`;
